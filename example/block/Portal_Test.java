...
import com.example.World.TeleporterTest;
...
public class Portal_Test extends BlockBreakable
{
    ...
    {
        Portal_Test.Size size = new Portal_Test.Size(worldIn, p_176548_2_, EnumFacing.Axis.X);
        ...
        {
            Portal_Test.Size size1 = new Portal_Test.Size(worldIn, p_176548_2_, EnumFacing.Axis.Z);
    ...
    public void onNeighborBlockChange(World worldIn, BlockPos pos, IBlockState state, Block neighborBlock)
    {
        ...
        Portal_Test.Size size;

        if (axis == EnumFacing.Axis.X)
        {
            size = new Portal_Test.Size(worldIn, pos, EnumFacing.Axis.X);
        ...
        {
            size = new Portal_Test.Size(worldIn, pos, EnumFacing.Axis.Z);
    ...
    public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entity)
    {
        if (entity.ridingEntity == null && entity.riddenByEntity == null && entity instanceof EntityPlayerMP)
        {
        	...
        	else if (player.dimension != ExampleMod.dimensionId)
        	{
        		player.timeUntilPortal = 10;
        		
        		player.mcServer.getConfigurationManager().transferPlayerToDimension(player, ExampleMod.dimensionId, new TeleporterTest(player.mcServer.worldServerForDimension(ExampleMod.dimensionId)));
        	}
        	else
        	{
        		player.timeUntilPortal = 10;
    ...
    public static class Size
        {
            ...
            protected int func_180120_a(BlockPos p_180120_1_, EnumFacing p_180120_2_)
            {
                ...
                for (i = 0; i < 22; ++i)
                {
                    ...
                    if (!this.func_150857_a(this.world.getBlockState(blockpos1).getBlock()) || this.world.getBlockState(blockpos1.down()).getBlock() != Blocks.sandstone)
                    {
                        break;
                    }
                }
            ...
            protected int func_150858_a()
            {
                ...
                for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
                {
                    for (i = 0; i < this.field_150868_h; ++i)
                    {
                        ...
                        if (block == TestBlock.portal_test)
                        {
                            ++this.field_150864_e;
                        }
                ...
                for (i = 0; i < this.field_150868_h; ++i)
                {
                    if (this.world.getBlockState(this.field_150861_f.offset(this.field_150866_c, i).up(this.field_150862_g)).getBlock() != Blocks.sandstone)
                    {
            ...
            {
                return p_150857_1_.getMaterial() == Material.air || p_150857_1_ == Blocks.fire || p_150857_1_ == TestBlock.portal_test;
            }
            ...
            public void func_150859_c()
            {
                for (int i = 0; i < this.field_150868_h; ++i)
                {
                    ...
                    {
                        this.world.setBlockState(blockpos.up(j), TestBlock.portal_test.getDefaultState().withProperty(Portal_Test.AXIS, this.axis), 2);
                    }
                }
            }
        }
