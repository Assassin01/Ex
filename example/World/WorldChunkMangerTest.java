...
public class WorldChunkMangerTest extends WorldChunkManager
{
	...
	protected WorldChunkMangerTest()
	{
		this.myBiomeCache = new BiomeCache(this);
		this.myBiomesToSpawnIn = new ArrayList<BiomeGenBase>();
		this.myBiomesToSpawnIn.add(ExampleMod.TestBiome);
	}

	public WorldChunkMangerTest(long seed, WorldType worldtype , String GeneratorOptions)
	{
		this();
	...
	public WorldChunkMangerTest(World world)
	{
	...
	public BiomeGenBase[] getBiomesForGeneration(BiomeGenBase[] p_76937_1_, int p_76937_2_, int p_76937_3_, int p_76937_4_, int p_76937_5_)
    {
        ...
        int[] aint = this.myGenBiomes.getInts(p_76937_2_, p_76937_3_, p_76937_4_, p_76937_5_);
